...
const quizQuestions = [
  ...
  },
  {
    ...
    answers: [
      { text: "Solid Snake", isCorrect: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Say hello to my large friend", isCorrect: false },
      { text: "Say hello to my little friend", isCorrect: true },
      { text: "Say bye bye to my little friend", isCorrect: false }
    ]
  },
  {
    ...
    answers: [
      ...
      { text: "Grieg: Peer Gynt Suite No. 1, Op. 46: I. Morning Mood", isCorrect: false },
      { text: "Be nice 2 me", isCorrect: false }
    ]
  },
  {
    ...
    answers: [
      ...
      { text: "Yusuf Enes", isCorrect: false },
  ...
  },
  {
    ...
    answers: [
      { text: "His mom", isCorrect: false },
      { text: "Voldemort", isCorrect: true },
  ...
  },
  {
    ...
    answers: [
      { text: "You shall pass", isCorrect: false },
      { text: "You will not pass", isCorrect: false },
      { text: "YOU SHALL NOT PASS!", isCorrect: true }
    ]
  },
  {
    question: "In the movie Ratatouille what animal controls the chef?",
    answers: [
      { text: "A gorilla", isCorrect: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Daniel Wroughton Craig", isCorrect: true },
      { text: "James Bond", isCorrect: false },
      { text: "Hannibal Lecter", isCorrect: false }
    ]
  },
  {
    question: "spongebob est amicus?",
    answers: [
      { text: "Patrick", isCorrect: true },
      { text: "Plankton", isCorrect: false },
      { text: "Perry the platypus", isCorrect: false }
    ]
  },
  {
    question: "ナヴィ族（アバター）の肌の色は何色ですか?",
    answers: [
      { text: "آبی", isCorrect: true },
      { text: "розовый", isCorrect: false },
